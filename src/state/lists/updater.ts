...
import { ARBITRUM_LIST, BASE_GOERLI_LIST, CELO_LIST, OPTIMISM_LIST, UNSUPPORTED_LIST_URLS } from 'constants/lists'
...
export default function Updater(): null {
  ...
  useEffect(() => {
    ...
    if (chainId && [SupportedChainId.BASE_GOERLI].includes(chainId)) {
      dispatch(enableList(BASE_GOERLI_LIST))
    }
