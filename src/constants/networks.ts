...
const INFURA_KEY_BASE_GOERLI = process.env.REACT_APP_INFURA_KEY_BASE_GOERLI
...
export const RPC_URLS: { [key in SupportedChainId]: string } = {
  ...
  [SupportedChainId.BASE_GOERLI]: `https://base-goerli.infura.io/v3/${INFURA_KEY_BASE_GOERLI}`,
