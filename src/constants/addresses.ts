...
// Base Goerli v3 addresses // TODO: update these
const BASE_GOERLI_V3_CORE_FACTORY_ADDRESSES = '0xBbBd280cABd6D5DeBE247DF076C1edeBFaA26254' // DONE
const BASE_GOERLI_V3_ROUTER_ADDRESS = '0x8253f01687B26BF4B09E3c87dAF7d3dD8A6e1a7C' // DONE
const BASE_GOERLI_V3_MIGRATOR_ADDRESSES = '0xA906A25194cD0Dea074dCA2F4073f0647a23dA34' // DONE
const BASE_GOERLI_MULTICALL_ADDRESS = '0x2204Ae70D8852E9B8122201719377c5e091633eA' // DONE
const BASE_GOERLI_QUOTER_ADDRESSES = '0x8253f01687B26BF4B09E3c87dAF7d3dD8A6e1a7C' // DONE
const BASE_GOERLI_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES = '0xCa8D86F47A0867b2dAf74b21285C3794858310dF' // DONE
const BASE_GOERLI_TICK_LENS_ADDRESSES = '0x50127cBB1fcC97DD528b566250e34155205050AE' // DONE
...
export const V3_ROUTER_ADDRESS: AddressMap = {
  ...
  [SupportedChainId.BASE_GOERLI]: BASE_GOERLI_V3_ROUTER_ADDRESS,
}
